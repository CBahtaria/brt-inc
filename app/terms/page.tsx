  ...
  return (
    <>
      ...
      <main className="max-w-2xl mx-auto px-6 py-32">
        ...
        <p className="font-mono text-xs uppercase tracking-widest mb-2" style={{ color: 'var(--text-subtle)' }}>Legal</p>
        ...
        <div className="space-y-8 text-sm leading-relaxed" style={{ color: 'var(--text-muted)' }}>
          ...
          <section>
            ...
            <p>Fixed-price projects require a 50% deposit before work begins, with the remainder due on delivery. Retainer engagements are invoiced monthly in advance. All prices are in South African Rand (ZAR) unless otherwise agreed. Payment by EFT or bank transfer. Invoices issued on request. Late payments accrue interest at 2% per month.</p>
          </section>
