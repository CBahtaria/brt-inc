...
const NODE_DETAIL: Record<string, { stack: string; desc: string; metrics: Record<string, string> }> = {
  ...
  brtinc:    { stack: 'Next.js 16 · Tailwind · Supabase · Vercel', desc: 'Institutional face of BRT Inc. 14 projects, case studies, live metrics, Trust & Security page. You are here.', metrics: { 'Projects': '14', 'Pages': '21 static', 'URL': 'brt-inc.vercel.app', 'Status': 'LIVE' } },
